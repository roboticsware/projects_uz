  ...
  <div class="min-h-[80vh] flex items-center justify-center px-4 py-12">
    <div class="max-w-md w-full bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
      <div class="text-center mb-8">
        ...
        <p class="text-gray-500 font-medium">Log in to track your progress</p>
      </div>
      ...
      <p class="mt-8 text-center text-sm text-gray-500 font-medium">
        ...
        <NuxtLink :to="localePath('/auth/signup')" class="text-blue-600 font-bold hover:underline">Sign up for free</NuxtLink>
      </p>
    </div>
  </div>
</template>
